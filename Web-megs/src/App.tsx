    ...
    <div style={{display: 'flex', height: '100vh', width: '100vw', background: 'var(--color-bg-main)', color: 'var(--color-text-main)'}}>
      <aside style={{width: '280px', background: 'var(--color-bg-card)', borderRight: '1px solid var(--color-border)', padding: '2rem'}}>
        ...
        <nav style={{display: 'flex', flexDirection: 'column', gap: '1.5rem', fontFamily: 'var(--font-mono)'}}>
          <Link to="/admin" style={{color: 'var(--color-text-muted)', fontSize: '0.8rem'}}>DASHBOARD</Link>
          <Link to="/admin/orders" style={{color: 'var(--color-text-muted)', fontSize: '0.8rem'}}>ORDERS</Link>
          <Link to="/admin/products" style={{color: 'var(--color-text-muted)', fontSize: '0.8rem'}}>PRODUCTS</Link>
          <Link to="/admin/articles" style={{color: 'var(--color-text-muted)', fontSize: '0.8rem'}}>JOURNAL ARTICLES</Link>
  ...
  return (
    <div style={{maxWidth: '1000px'}}>
      <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2rem'}}>
        ...
        <Link to="/admin/products/new" className="btn-primary" style={{padding: '0.8rem 1.5rem'}}>+ ADD NEW</Link>
      </div>
  ...
  return (
    <div style={{maxWidth: '800px'}}>
      <div style={{display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem'}}>
        <Link to="/admin/products" style={{textDecoration: 'none', color: 'var(--color-text-muted)'}}>←</Link>
  ...
  return (
    <div style={{maxWidth: '1000px'}}>
      <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2rem'}}>
        ...
        <Link to="/admin/articles/new" className="btn-primary" style={{padding: '0.8rem 1.5rem'}}>+ ADD NEW</Link>
      </div>
...
function AdminArticleForm() {
  ...
  return (
    <div style={{maxWidth: '800px'}}>
      <div style={{display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem'}}>
        <Link to="/admin/articles" style={{textDecoration: 'none', color: 'var(--color-text-muted)'}}>←</Link>
        <h2 style={{fontFamily: 'var(--font-sans)', fontWeight: 900, fontSize: '3rem', letterSpacing: '-0.05em', textTransform: 'uppercase', margin: 0}}>
